...
import { resolveAIRequestContext } from "../../../src/ai/requestContext.js"
...
vi.mock("../../../src/ai/tokenUsage.js", async () => ({
    ...(await vi.importActual<typeof import("../../../src/ai/tokenUsage.js")>("../../../src/ai/tokenUsage.js")),
